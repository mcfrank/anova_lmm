...
\item Reiterate that any theoretical weakness of LMM is a weakness of RANOVA as well because latter is a special case. Computationally, when specification is equivalent, maybe RANOVA is useful for closed-form p-values and convergence? 
\end{enumerate}
